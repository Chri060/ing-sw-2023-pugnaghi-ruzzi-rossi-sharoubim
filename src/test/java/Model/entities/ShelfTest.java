...
class ShelfTest {
    ...
    /**
     * Checks if the shelf is correct
     */
    @Test
    void constructorTest() throws InvalidArgumentException {
        assert (shelf.getRows() == 6);
        assert (shelf.getColumns() == 5);
        assert (!shelf.isFull());
        ...
        assert (shelf.getIterator() != null);
        assert (shelf.asMatrix() != null);
        assert (shelf.maxFreeSpace() == 6);
    }

    /**
     * Checks various insertion situations
     */
    @Test
    ...
    /**
     * Fills the shelf with same type cards
     */
    @Test
    void fullTest() {
